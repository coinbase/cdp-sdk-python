...
class ServerSignerEventList(BaseModel):
    """
    ...
    total_count: StrictInt = Field(description="The total number of events for the server signer.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ServerSignerEvent.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
