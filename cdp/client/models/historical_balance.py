...
class HistoricalBalance(BaseModel):
    ...
    block_hash: StrictStr = Field(
        description="The hash of the block at which the balance was recorded"
    )
    block_height: StrictStr = Field(
        description="The block height at which the balance was recorded"
    )
    asset: Asset
