...
class ContractEvent(BaseModel):
    ...
    contract_name: StrictStr = Field(
        description="The name of the specific contract within the project"
    )
    ...
    four_bytes: StrictStr = Field(
        description="The first four bytes of the Keccak hash of the event signature"
    )
