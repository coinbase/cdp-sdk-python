...
class FetchStakingRewardsRequest(BaseModel):
    ...
    asset_id: StrictStr = Field(
        description="The ID of the asset for which the staking rewards are being fetched"
    )
    address_ids: list[StrictStr] = Field(
        description="The onchain addresses for which the staking rewards are being fetched"
    )
