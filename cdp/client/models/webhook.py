...
class Webhook(BaseModel):
    ...
    id: StrictStr | None = Field(default=None, description="Identifier of the webhook.")
    network_id: StrictStr | None = Field(
        default=None, description="The ID of the blockchain network"
    )
    event_type: WebhookEventType | None = None
    event_type_filter: WebhookEventTypeFilter | None = None
    event_filters: list[WebhookEventFilter] | None = Field(
        default=None,
        description="Webhook will monitor all events that matches any one of the event filters.",
    )
    notification_uri: StrictStr | None = Field(
        default=None, description="The URL to which the notifications will be sent."
    )
    created_at: datetime | None = Field(
        default=None, description="The date and time the webhook was created."
    )
    updated_at: datetime | None = Field(
        default=None, description="The date and time the webhook was last updated."
    )
    signature_header: StrictStr | None = Field(
        default=None,
        description="The header that will contain the signature of the webhook payload.",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "event_type_filter": WebhookEventTypeFilter.from_dict(obj["event_type_filter"])
                if obj.get("event_type_filter") is not None
                else None,
                "event_filters": [
                    WebhookEventFilter.from_dict(_item) for _item in obj["event_filters"]
                ]
                if obj.get("event_filters") is not None
                else None,
