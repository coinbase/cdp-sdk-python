...
class SmartContractOptions(BaseModel):
    ...
    oneof_schema_1_validator: Optional[TokenContractOptions] = None
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, NFTContractOptions):
            ...
            match += 1
        # validate data type: MultiTokenContractOptions
        if not isinstance(v, MultiTokenContractOptions):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into MultiTokenContractOptions
        try:
            instance.actual_instance = MultiTokenContractOptions.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
