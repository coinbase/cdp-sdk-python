...
class ContractInvocationList(BaseModel):
    """
    ...
    total_count: StrictInt = Field(description="The total number of contract invocations for the address in the wallet.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ContractInvocation.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
