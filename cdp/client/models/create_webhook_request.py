...
class CreateWebhookRequest(BaseModel):
    ...
    notification_uri: StrictStr = Field(
        description="The URL to which the notifications will be sent"
    )
    signature_header: StrictStr | None = Field(
        default=None,
        description="The custom header to be used for x-webhook-signature header on callbacks, so developers can verify the requests are coming from Coinbase.",
    )
