...
class ContractEventList(BaseModel):
    """
    A list of contract events with pagination information
    """ # noqa: E501
    data: List[ContractEvent] = Field(description="An array of ContractEvent objects")
    ...
    __properties: ClassVar[List[str]] = ["data", "next_page", "has_more"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ContractEvent.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
