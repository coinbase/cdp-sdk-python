...
class Wallet(BaseModel):
    ...
    server_signer_status: StrictStr | None = Field(
        default=None, description="The status of the Server-Signer for the wallet if present."
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "default_address": Address.from_dict(obj["default_address"])
                if obj.get("default_address") is not None
                else None,
                "feature_set": FeatureSet.from_dict(obj["feature_set"])
                if obj.get("feature_set") is not None
                else None,
