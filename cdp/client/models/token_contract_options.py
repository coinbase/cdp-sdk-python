...
class TokenContractOptions(BaseModel):
    """
    ...
    total_supply: StrictStr = Field(description="The total supply of the token denominated in the whole amount of the token.")
    __properties: ClassVar[List[str]] = ["name", "symbol", "total_supply"]
