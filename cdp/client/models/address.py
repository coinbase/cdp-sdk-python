...
class Address(BaseModel):
    ...
    public_key: StrictStr = Field(description="The public key from which the address is derived.")
    address_id: StrictStr = Field(description="The onchain address derived on the server-side.")
    index: StrictInt = Field(description="The index of the address in the wallet.")
