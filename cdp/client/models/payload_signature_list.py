...
class PayloadSignatureList(BaseModel):
    ...
    total_count: StrictInt = Field(description="The total number of payload signatures for the address.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PayloadSignature.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
