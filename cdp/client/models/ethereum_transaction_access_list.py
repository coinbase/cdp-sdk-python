...
class EthereumTransactionAccessList(BaseModel):
    ...
    access_list: list[EthereumTransactionAccess] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "access_list": [
                    EthereumTransactionAccess.from_dict(_item) for _item in obj["access_list"]
                ]
                if obj.get("access_list") is not None
                else None
            }
        )
        return _obj
