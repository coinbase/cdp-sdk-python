...
class EthereumValidatorMetadata(BaseModel):
    ...
    withdrawal_address: StrictStr = Field(
    ...
    activation_epoch: StrictStr = Field(
        description="The epoch at which the validator was activated.", alias="activationEpoch"
    )
    exit_epoch: StrictStr = Field(
        description="The epoch at which the validator exited.", alias="exitEpoch"
    )
    withdrawable_epoch: StrictStr = Field(
        description="The epoch at which the validator can withdraw.", alias="withdrawableEpoch"
    )
    balance: Balance
        ...
        _obj = cls.model_validate(
            {
                ...
                "effective_balance": Balance.from_dict(obj["effective_balance"])
                if obj.get("effective_balance") is not None
                else None,
            }
        )
        return _obj
