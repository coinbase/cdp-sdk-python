...
class BuildStakingOperationRequest(BaseModel):
    ...
    address_id: StrictStr = Field(
        description="The onchain address from which the staking transaction originates and is responsible for signing the transaction."
    )
