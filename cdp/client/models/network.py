...
class Network(BaseModel):
    ...
    address_path_prefix: StrictStr | None = Field(
        default=None, description="The BIP44 path prefix for the network"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "native_asset": Asset.from_dict(obj["native_asset"])
                if obj.get("native_asset") is not None
                else None,
