...
class ServerSignerList(BaseModel):
    """
    ...
    total_count: StrictInt = Field(description="The total number of server-signers for the project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ServerSigner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
