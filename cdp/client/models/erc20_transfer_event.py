...
class ERC20TransferEvent(BaseModel):
    ...
    event_type: Optional[StrictStr] = Field(default=None, description="Type of event, in this case, an ERC-20 token transfer.", alias="eventType")
    ...
    contract_address: Optional[StrictStr] = Field(default=None, description="Address of the ERC-20 token contract.", alias="contractAddress")
    ...
    value: Optional[StrictStr] = Field(default=None, description="Amount of tokens transferred, typically in the smallest unit (e.g., wei for Ethereum).")
    __properties: ClassVar[List[str]] = ["webhookId", "eventType", "network", "blockHash", "blockNumber", "blockTime", "transactionHash", "transactionIndex", "logIndex", "contractAddress", "from", "to", "value"]
