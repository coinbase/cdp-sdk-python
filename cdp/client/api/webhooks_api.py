...
class WebhooksApi:
    ...
    def create_webhook(
        self,
        create_webhook_request: CreateWebhookRequest | None = None,
    ...
    def delete_webhook(
        ...
        webhook_id: Annotated[
            StrictStr, Field(description="The Webhook uuid that needs to be deleted")
        ],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
    ...
    def update_webhook(
        self,
        webhook_id: Annotated[
            StrictStr, Field(description="The Webhook id that needs to be updated")
        ],
        update_webhook_request: UpdateWebhookRequest | None = None,
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
