...
class ContractInvocationsApi:
    ...
    def broadcast_contract_invocation(
        ...
        address_id: Annotated[
            StrictStr,
            Field(description="The ID of the address the contract invocation belongs to."),
        ],
        contract_invocation_id: Annotated[
            StrictStr, Field(description="The ID of the contract invocation to broadcast.")
        ],
    ...
    def create_contract_invocation(
        ...
        address_id: Annotated[
            StrictStr, Field(description="The ID of the address to invoke the contract from.")
        ],
    ...
    def get_contract_invocation(
        ...
        contract_invocation_id: Annotated[
            StrictStr, Field(description="The ID of the contract invocation to fetch.")
        ],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
    ...
    def list_contract_invocations(
        ...
        address_id: Annotated[
            StrictStr, Field(description="The ID of the address to list contract invocations for.")
        ],
        limit: Annotated[
            StrictInt | None,
            Field(
