...
class BalanceHistoryApi:
    ...
    def list_address_historical_balance(
        ...
        address_id: Annotated[StrictStr, Field(description="The ID of the address to fetch the historical balance for.")],
        asset_id: Annotated[StrictStr, Field(description="The symbol of the asset to fetch the historical balance for.")],
