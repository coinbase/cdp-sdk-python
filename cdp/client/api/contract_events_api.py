...
class ContractEventsApi:
    ...
    def list_contract_events(
        ...
        network_id: Annotated[
            StrictStr, Field(description="Unique identifier for the blockchain network")
        ],
        protocol_name: Annotated[
            StrictStr, Field(description="Case-sensitive name of the blockchain protocol")
        ],
        contract_address: Annotated[
            StrictStr,
            Field(
                description="EVM address of the smart contract (42 characters, including '0x', in lowercase)"
            ),
        ],
        contract_name: Annotated[
            StrictStr,
            Field(description="Case-sensitive name of the specific contract within the project"),
        ],
        event_name: Annotated[
            StrictStr,
            Field(
                description="Case-sensitive name of the event to filter for in the contract's logs"
            ),
        ],
        from_block_height: Annotated[
            StrictInt, Field(description="Lower bound of the block range to query (inclusive)")
        ],
        to_block_height: Annotated[
            StrictInt, Field(description="Upper bound of the block range to query (inclusive)")
        ],
        next_page: Annotated[
            StrictStr | None,
            Field(description="Pagination token for retrieving the next set of results"),
        ] = None,
