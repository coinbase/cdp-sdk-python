...
class TransfersApi:
    ...
    def broadcast_transfer(
        ...
        address_id: Annotated[
            StrictStr, Field(description="The ID of the address the transfer belongs to")
        ],
    ...
    def create_transfer(
        ...
        address_id: Annotated[
            StrictStr, Field(description="The ID of the address to transfer from")
        ],
    ...
    def list_transfers(
        ...
        address_id: Annotated[
            StrictStr, Field(description="The ID of the address to list transfers for")
        ],
        limit: Annotated[
            StrictInt | None,
            Field(
