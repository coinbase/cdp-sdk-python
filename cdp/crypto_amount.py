...
class CryptoAmount:
    ...
    def from_model(cls, crypto_amount_model: CryptoAmountModel) -> "CryptoAmount":
        ...
        Args:
            amount_model (CryptoAmountModel): The crypto amount from the API.
    ...
    @classmethod
    def from_model_and_asset_id(cls, crypto_amount_model: CryptoAmountModel, asset_id: str) -> "CryptoAmount":
        ...
        return cls(
            amount=asset.from_atomic_amount(crypto_amount_model.amount), asset=asset, asset_id=asset_id
        )
