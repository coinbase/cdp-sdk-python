...
class NetworkScopedSmartWallet(SmartWallet):
    ...
    def send_user_operation(
        ...
        return super().send_user_operation(
            ...
            paymaster_url=self.network.paymaster_url
        )
    ...
    def __repr__(self) -> str:
        ...
        """
        return f"NetworkScopedSmartWallet(model=SmartWalletModel(address='{self.address}'), network=Network(chain_id={self.network.chain_id}, paymaster_url={repr(self.network.paymaster_url)}))"