...
def address_reputation_model_factory():
    ...
    def _create_address_reputation_model(
        ...
        return AddressReputationModel(score=score, metadata=metadata)
...
def address_reputation_factory(address_reputation_model_factory):
    ...
    def _create_address_reputation(score=10):
        reputation_model = address_reputation_model_factory(score=score)
